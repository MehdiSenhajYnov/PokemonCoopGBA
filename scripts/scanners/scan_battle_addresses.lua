...
console:log("")
console:log("=== STEP 7: Find gTrainerBattleOpponent_A ===")
console:log("  a) Enter a TRAINER battle")
console:log("  b) Execute: tba = scan16(TRAINER_ID)")
console:log("     If trainer ID unknown, try prediction:")
console:log(string.format("     predicted = 0x%08X (vanilla 0x02038BCA + 0x878)", predictRB(0x02038BCA)))
console:log("     Execute: peek(0x02039442, 2) -- check if non-zero during trainer battle")
console:log("  c) Win or flee the battle")
console:log("  d) Execute: tba = rescan(tba, 0, 2)")
console:log("  e) Execute: show(tba, 'gTrainerBattleOpponent_A')")
console:log("")
